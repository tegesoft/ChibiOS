...
stm32_declare_feature(GPT     "${STM32_SRC_ROOT}" gpt_lld.h gpt_lld.c)
stm32_declare_feature(I2S     "${STM32_SRC_ROOT}" i2s_lld.h i2s_lld.c)
stm32_declare_feature(ICU     "${STM32_SRC_ROOT}" icu_lld.h icu_lld.c)
stm32_declare_feature(MAC     "${STM32_SRC_ROOT}" mac_lld.h mac_lld.c)
stm32_declare_feature(PWM     "${STM32_SRC_ROOT}" pwm_lld.h pwm_lld.c)
stm32_declare_feature(SDC     "${STM32_SRC_ROOT}" sdc_lld.h sdc_lld.c)
stm32_declare_feature(SERIAL  "${STM32_SRC_ROOT}" serial_lld.h serial_lld.c)
stm32_declare_feature(SPI     "${STM32_SRC_ROOT}" spi_lld.h spi_lld.c)
...
stm32_declare_feature(USARTv1 "${STM32_SRC_ROOT}/USARTv1" uart_lld.h uart_lld.c)
stm32_declare_feature(USARTv2 "${STM32_SRC_ROOT}/USARTv2" uart_lld.h uart_lld.c)
