...
# debug options
macro(chibios_debug_option variable description definition)
    option(${variable} ${description} FALSE)
    if(${variable})
        add_definitions("-D${definition}")
    endif()
endmacro()
chibios_debug_option(CHIBIOS_DBG_DISABLE_OPTIMIZE_SPEED "Disable speed optimizations in the kernel" CH_OPTIMIZE_SPEED=0)
chibios_debug_option(CHIBIOS_DBG_ENABLE_CHECKS          "Enable checks on the API parameters"       CH_DBG_ENABLE_CHECKS=1)
chibios_debug_option(CHIBIOS_DBG_ENABLE_ASSERTS         "Enable the OS internal consistency checks" CH_DBG_ENABLE_ASSERTS=1)
chibios_debug_option(CHIBIOS_DBG_ENABLE_TRACE           "Enable the trace buffer"                   CH_DBG_ENABLE_TRACE=1)
chibios_debug_option(CHIBIOS_DBG_ENABLE_STACK_CHECK     "Enable checks on thread stack overflow"    CH_DBG_ENABLE_STACK_CHECK=1)
chibios_debug_option(CHIBIOS_DBG_SYSTEM_STATE_CHECK     "Enable checks on calls to OS functions"    CH_DBG_SYSTEM_STATE_CHECK=1)
chibios_debug_option(CHIBIOS_DBG_FILL_THREAD            "Enable threads workspace filling"          CH_DBG_FILL_THREADS=1)
chibios_debug_option(CHIBIOS_DBG_THREADS_PROFILING      "Enable thread profiling"                   CH_DBG_THREADS_PROFILING=1)
